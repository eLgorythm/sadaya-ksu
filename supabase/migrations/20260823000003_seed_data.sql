...
insert into public.app_settings (key, value, description) values
  ...
  ('interest_rate_normal',   '0.02',   'Bunga pinjaman normal per bulan (tenor >= 10)'),
  ('interest_rate_short',    '0.03',   'Bunga pinjaman jangka pendek (< 10 bulan)'),
  ('admin_fee_rate',         '0.03',   'Biaya administrasi pinjaman'),
  ...
  ('japinup_ratio',          '11',     'Bagian Japinup dari rasio distribusi jasa'),
  ('social_fund_ratio',      '0.5',    'Bagian Dana Sosial'),
  ('education_fund_ratio',   '0.5',    'Bagian Dana Pendidikan'),
  ('crk_ratio',              '0.5',    'Bagian Dana CRK'),
  ('development_fund_ratio', '0.5',    'Bagian Dana Pembangunan'),
  ('swk_ratio',              '2',      'Bagian SWK'),
  ('welfare_fund_ratio',     '5',      'Bagian Dana Kesra'),
  ('total_ratio_parts',      '20',     'Total bagian rasio distribusi jasa'),
